...
function arlo_tm_kenburn_slider(){
	...
	"use strict";
		...
		jQuery(function() {
			...
			slides: [
				{ src: 'html/arlo/img/slider/1.jpg' },
				{ src: 'html/arlo/img/slider/2.jpg' },
				{ src: 'html/arlo/img/slider/3.jpg' },
			]
...
function arlo_tm_animate_text(){
	...
	animateSpan.typed({
		strings: ["Mechanical and Mechatronics Engineering Student", "CAD Designer", "Discord Server Manager"],
		loop: true,
		startDelay: 1e3,
		backDelay: 2e3
	});
